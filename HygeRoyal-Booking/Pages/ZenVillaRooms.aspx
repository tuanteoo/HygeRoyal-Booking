<%@ Page Title="Hyge Royal | Zen Villa Empty Rooms" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="ZenVillaRooms.aspx.cs" Inherits="HygeRoyal_Booking.Pages.ZenVillaRooms" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript" src="../Scripts/zenvilla_rooms.js"></script>
</asp:Content>
