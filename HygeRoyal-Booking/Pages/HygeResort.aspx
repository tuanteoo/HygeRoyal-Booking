<%@ Page Title="Hyge Royal | Hyge Resort" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="HygeResort.aspx.cs" Inherits="HygeRoyal_Booking.Pages.HygeResort" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" type="text/css" href="../Content/css/hygeresort.css"/>
</asp:Content>
    ...
    <main class="container">
        <div class="container__story">
            ...
            <div class="container__story--banner">
                <img src="../Content/images/hyge-banner.png" alt="Banner Story">
            </div>
        </div>
            ...
            <div class="container__rooms--item">
                <div class="luxury">
                    <div>
                        ...
                        <a href="HygeResortRooms.aspx" class="view-more">View More</a>
                        <a href="HygeResortRooms.aspx" class="book-room"> Book Room</a>    
                    </div>
                </div>
                <div class="heritage">
                    <div>
        ...
        <div class="container__gallery">
            ...
            <div>
                <img src="../Content/images/hyge-gallery1.png" alt="Hyge Royal Escape">
                <img src="../Content/images/hyge-gallery2.png" alt="Hyge Royal Escape">
                <img src="../Content/images/hyge-gallery3.png" alt="Hyge Royal Escape">
                <img src="../Content/images/hyge-gallery4.png" alt="Hyge Royal Escape">
                <img src="../Content/images/hyge-gallery5.png" alt="Hyge Royal Escape">
                <img src="../Content/images/hyge-gallery6.png" alt="Hyge Royal Escape">
            </div>
        </div>
