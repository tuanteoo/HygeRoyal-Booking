...
{
    public partial class HygeResortRooms : System.Web.UI.Page
    {
        private readonly string connectionString = ConfigurationManager.ConnectionStrings["myConnectionString"].ConnectionString;
        private readonly string CONDITION_DATA = "Hyge Resort";
        protected List<RoomModel> listroom = new List<RoomModel>();
        protected List<RoomModel> listbooking = new List<RoomModel>();
